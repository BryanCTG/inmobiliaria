...
// @RestController
// @RequestMapping("/api/propiedades")
// @CrossOrigin(origins = "*") // Permitir peticiones desde JS
// public class PropiedadRestController {

//     private final PropiedadRepository repo;

//     public PropiedadRestController(PropiedadRepository repo) {
//         this.repo = repo;
//     }
...
//     @PutMapping("/{id}")
//     public Propiedad actualizar(@PathVariable String id, @RequestBody Propiedad nueva) {
//         nueva.setId(id);
...
//     // Listar solo las propiedades visibles (para la página pública)
// @GetMapping("/visibles")
// public List<Propiedad> listarVisibles() {
//     return repo.findAll()
//                .stream()
